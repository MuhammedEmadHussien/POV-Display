...
void MDIO_voidSetPortValue (u8 port, u8 val)
{
    switch (port)
    {
        case A:
            switch (val)
            {
                case HIGH:    PORTA = 255; break;
                case LOW:     PORTA = 0;   break;
                default: break;
            }
            break;
        case B:
            switch (val)
            {
                case HIGH:    PORTB = 255; break;
                case LOW:     PORTB = 0;   break;
                default: break;
            }
            break;
        case C:
            switch (val)
            {
                case HIGH:    PORTC = 255; break;
                case LOW:     PORTC = 0;   break;
                default: break;
            }
            break;
        case D:
            switch (val)
            {
                case HIGH:    PORTD = 255; break;
                case LOW:     PORTD = 0;   break;
                default: break;
            }
            break;
        default: break;
